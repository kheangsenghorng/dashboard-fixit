    ...
    <div className="max-w-2xl mx-auto py-10 px-4 relative">
      ...
      <AnimatePresence>
        {isSubmitting && (
          ...
          >
            <ContentLoader title="Saving" subtitle="Updating category..." Icon={Sparkles} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        ...
        <div className="p-10 bg-slate-900 text-white flex justify-between items-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-3xl font-black tracking-tight">Edit Service</h1>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-5">Change Category Image</p>
          </div>
