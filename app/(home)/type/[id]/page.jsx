    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-amber-100">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <header className="mb-12">
          ...
          >
            {category.icon && (
              <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl flex items-center justify-center shadow-md shadow-amber-200">
                <img
                  src={category.icon}
                  alt=""
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-semibold hover:bg-amber-600 transition-all shadow-md">
